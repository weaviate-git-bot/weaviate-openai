...
def main():
    ...
    url = "https://30jxk6esqcc7zwzxlfqea.c0.asia-southeast1.gcp.weaviate.cloud"
    auth_config = weaviate.AuthApiKey(
        api_key="TNXQGwqIoL5MZNFrP7DGOBngy52dBsPvdU4l")
    main_client = Client(url=url, auth_client_secret=auth_config,
                         additional_headers={
                             "X-Azure-Api-Key": "d8e8fc52cbfe4495adc605fe412ce3eb"
                         })
    wait_time_limit = 240
